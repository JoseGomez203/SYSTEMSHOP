...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <h1 class="display-4 mt-3 text-center mb-3"> ¿Seguro que eliminaras?</h1>

    <form class="contenedorForma" action="controlador.php" method="post">
      ...
      <button type="submit" name="btnEliminar" class="btn btn-warning">SI, Eiminarlo</button>
